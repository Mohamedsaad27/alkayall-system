...
<div class="card-body">
    <div class="row">
        ...
        @if ($settings->display_brands)
            <div class="col-lg-4">
                <x-form.select class="form-control select2" id="brand_id" :collection="$brands" 
        ...
        <div class="col-lg-4">
            <div class="form-group mt-4">
                <div class="traffic-light-toggle">
                    <input type="checkbox" id="forSale" name="is_published" value="1" class="traffic-light-input"
                        checked @checked((isset($data) && $data->is_published) || old('is_published') == '1')>
                    <label for="forSale" class="traffic-light-label">
                        <span class="traffic-light"></span>
                        <span class="label-text mr-2 text-bold ">للنشر</span>
                    </label>
                </div>
            </div>
        </div>
