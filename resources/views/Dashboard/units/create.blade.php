    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('dashboard.home')}}">{{ trans('admin.Home') }}</a> / <a href="{{route('dashboard.units.index')}}">{{ trans('admin.units') }}</a> / {{ trans('admin.Create') }}</li>
            </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
<script>
    $(document).ready(function() {
        ...
        setupSelect2Autofocus('#base_unit_id', 'اختر القسم الرئيسي');
    });
</script>
@endsection
