...
@section('title', trans('admin.Discounts'))
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    @if (auth('user')->user()->has_permission('create-discounts'))
                        <a href="{{ route('dashboard.hr.discount.create') }}" type="button"
...
@section('script')
    <script type="text/javascript">
        var table = $('.data-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                "url": "{{ route('dashboard.hr.discount.index') }}",
                "data": function(d) {
