        ...
        <div class="row">
            <form method="POST" style="width: 100%" action="">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="amount" type="number" class="form-control @error('amount') is-invalid @enderror" name="amount" autocomplete="amount" autofocus>
                ...
                <div class="form-group row mb-0">
                    <div class="col-md-6 offset-md-4">
                        <button type="button" value="multi_pay" name="sell_type" class="btn button-send btn-primary">
                            {{ __('admin.Pay') }}
                        </button>
                    </div>
                </div>
