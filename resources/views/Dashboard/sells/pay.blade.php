<div class="row">
    <div class="col-lg-12">
        <div class="row">
            <form method="POST" style="width: 100%" action="{{ route('dashboard.sells.payTransaction', $transaction->id) }}">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="amount" type="number"{{ $readonly}} class="form-control @error('amount') is-invalid @enderror" name="amount" value="{{ old('amount', $amountMustPay) }}" required autocomplete="amount" autofocus>
