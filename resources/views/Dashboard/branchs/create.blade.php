    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('dashboard.home')}}">{{ trans('admin.Home') }}</a> / <a href="{{route('dashboard.branchs.index')}}">{{ trans('admin.branchs') }}</a> / {{ trans('admin.Create') }}</li>
            </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form method="post" action="{{ route('dashboard.branchs.store') }}">
                    @csrf
...
<script>
    $(document).ready(function() {
        ...
        setupSelect2Autofocus('#credit_account_id', 'اختر الحساب الاجل');
        setupSelect2Autofocus('#cash_account_id', 'اختر الحساب النقدي');
    });
</script>
@endsection
