                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard.home') }}">{{ trans('admin.Home') }}</a> / <a
                                href="{{ route('dashboard.spoiled-stock.index') }}">{{ trans('admin.spoiled_stock') }}</a> /
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="post" action="{{ route('dashboard.spoiled-stock.store') }}" id="spoiledStockForm">
                            @csrf
                            @include('Dashboard.spoiled-stock.form')
                            <!-- /.card-body -->
...
@section('script')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#spoiledStockForm').on('change', '.product_purchase_add', function() {
                ...
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        ...
                        alert(
                            'Error occurred while adding product row. Please check the console for more details.');
                    }
                });
            });
