            ...
            <table id="example1" class="table table-bordered table-striped responsive">
              ...
              <tbody>
                  @foreach ($categories as $category)
                      <tr>
                          <td>{{$category->id}}</td>
                          <td><img src="{{ $category && method_exists($category, 'getMedia') && $category->getMedia('category_cover')->first() 
                            ? $category->getMedia('category_cover')->first()->getUrl() 
                            : asset('assets/pages/img/products/model2.jpg') }}" alt="" style="width: 100px; height: auto;"> </td>
                          <td>{{$category->name}}</td>
